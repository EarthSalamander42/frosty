...
function OpenDoor(door, bool)
local DoorObs = Entities:FindAllByName(door.."_obs")
	...
	if bool == true then
		DoEntFire(door, "SetAnimation", "open", 0, nil, nil)
	else
		DoEntFire(door, "SetAnimation", "close_idle", 0, nil, nil)
	end
end
