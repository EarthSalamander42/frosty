_G.ZonesDefinition =
{
	...
	--------------------------------------------------
	{
		...
		{
			{
				...
				{	
					...
					szNPCName = "npc_dota_tavern_tuskarr",
					nDialogLine = 2,
				},
			},
			{
				szQuestName = "rylai_is_back",
				szQuestType = "Speak",
				Activators = 
				{
					{
				...
				{	
					...
					szNPCName = "npc_dota_tavern_kardel",
					nDialogLine = 3,
				},
			},
			{
		...
		{
			{
				szVIPName = "npc_dota_tavern_tuskarr",
				szSpawnerName = "tavern_holdout_spawner_tuskarr_vip",
				nCount = 1,
				Activity = ACT_DOTA_IDLE,
			},
			{
				szVIPName = "npc_dota_tavern_kardel",
				szSpawnerName = "tavern_holdout_spawner_kardel_vip",
				nCount = 1,
				Activity = ACT_DOTA_IDLE,
			},
		},
